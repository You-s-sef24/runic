...
const CATEGORIES = [
  { id: "accessories", translationKey: "categories.accessories" },
...
const SORT_OPTIONS = [
  {
    value: "newest",
    labelKey: "categoryProducts.sortOptions.newest",
    sortBy: "id",
    order: "desc",
  },
  {
    value: "priceLowToHigh",
    labelKey: "categoryProducts.sortOptions.priceLowToHigh",
    sortBy: "price",
    order: "asc",
  },
  {
    value: "priceHighToLow",
    labelKey: "categoryProducts.sortOptions.priceHighToLow",
    sortBy: "price",
    order: "desc",
  },
];
