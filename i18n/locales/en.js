const en = {
  about: {
    ...
    values: {
      minimalistDesign: {
        ...
        description:
          "We believe in clean lines, functional spaces, and stripping away the noise to showcase true craftsmanship.",
      },
      premiumQuality: {
        title: "Premium Quality",
        description:
          "From sustainable oak frames to ultra-durable canvas boards, every single piece is built with elite grade materials.",
      },
      handcraftedCare: {
        title: "Handcrafted Care",
        description:
          "Every item is carefully inspected and packaged to ensure it reaches your home in flawless condition.",
      },
    },
    faqs: {
      shipping: {
        ...
        answer:
          "Standard domestic shipping takes between 3 to 5 business days. International shipping estimates range from 7 to 14 business days depending on customs processing.",
      },
      returns: {
        question: "What is your return policy?",
        answer:
          "We offer a 30-day hassle-free return window for all unused items in their original packaging. Please reach out to our support team to generate a free return label.",
      },
      customDimensions: {
        question: "Do you offer custom dimensions for boards and frames?",
        answer:
          "Currently, we only supply the dimensions listed on each product catalog. However, we update our collections regularly with fresh standard fits based on customer requests.",
      },
    },
  },
  home: {
    ...
    heroSubtitle:
      "Premium frames, automotive shelves, tech accessories, and more — crafted with precision, designed for you.",
    exploreCollection: "Explore Collection",
  ...
  features: {
    ...
    delivery: {
      ...
      description:
        "We deliver to every corner of Egypt, bringing your Runic order straight to your doorstep with reliable and convenient shipping.",
    },
    madeByRunic: {
      title: "Made by Runic",
      description:
        "Every product is designed, manufactured, and produced from scratch by Runic, ensuring exceptional quality and attention to every detail.",
    },
    satisfaction: {
      title: "Your Satisfaction Matters",
      description:
        "Your complete satisfaction is our top priority. We're committed to delivering products and experiences that meet your expectations every time.",
    },
  },
  card: {
